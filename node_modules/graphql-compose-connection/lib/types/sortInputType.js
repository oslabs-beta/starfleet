...
function prepareSortType(typeComposer, opts) {
  ...
  const typeName = `Sort${(0, _graphqlCompose.upperFirst)(opts.connectionResolverName || 'connection')}${typeComposer.getTypeName()}Enum`;
...
function checkSortOpts(key, opts) {
  ...
  if (!opts.beforeCursorQuery || !(0, _graphqlCompose.isFunction)(opts.beforeCursorQuery)) {
  ...
  if (!opts.afterCursorQuery || !(0, _graphqlCompose.isFunction)(opts.afterCursorQuery)) {
