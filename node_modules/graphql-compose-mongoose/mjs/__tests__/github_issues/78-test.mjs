...
describe('issue #78 - Mongoose and Discriminators', () => {
  ...
  it('manually override resolver output type for findMany', async () => {
    ...
    EventTC.getResolver('findMany').setType(new graphql.GraphQLList(EventDescriminatorType)); // let's check graphql response
    ...
    const res = await graphql.graphql(schema, `{
    eventFindMany {
        __typename
        ... on GenericEvent {
        refId
