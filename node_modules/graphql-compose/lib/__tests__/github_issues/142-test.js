...
`;
  ...
  it('extend Object type', async () => {
    expect(_2.schemaComposer.Query.getFieldNames()).toEqual(['posts', 'author']);

    _2.schemaComposer.addTypeDefs(`
      extend type Query {
        test: String!
      }
    `);

    expect(_2.schemaComposer.Query.getFieldNames()).toEqual(['posts', 'author', 'test']);
  });
});